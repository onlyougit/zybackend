    ...
    <div id="form1">
		...
		<table border="0" cellpadding="1" cellspacing="2">
			<tr>
				...
				<td>
					<input name="customerPhone" emptyText="请输入客户电话" class="mini-textbox" onenter="search"/>
				</td>
				<td>
					客户姓名：
				</td>
				<td>
					<input name="customerRealName" emptyText="请输入客户姓名" class="mini-textbox" onenter="search"/>
				</td>
			</tr>
		</table>
		<table>
...
<div style="width:99%;">
	<div class="mini-toolbar" style="border-bottom:0;padding:0px;">
		<table style="width:100%;">
			<tr>
				<td style="width:100%;">
					<form action="/customer/exportCustomer.action" method="post" name="form2" id="form2">
						<input type="hidden" name="queryParam" id="queryParam" class="mini-hidden">
						<a class="mini-button" iconCls="icon-download" onclick="exportCustomer()">导出</a>
...
<div id="datagrid1" class="mini-datagrid" style="width:99%;height:71%;" sizeList="[20,30,50,100]" pageSize="20"
     url="/customer/queryHeadCustomer.action" idField="id" allowResize="true" allowCellWrap="true"
    ...
    <div property="columns">
        ...
        <div field="customerName" width="100" headerAlign="center" align="center">交易账号</div>
        <div field="customerPhone" width="120" headerAlign="center" align="center">客户手机号</div>
        <div field="customerRealName" width="100" headerAlign="center" align="center">客户姓名</div>
        <div field="customerCardId" width="120" headerAlign="center" align="center">身份证</div>
		<div field="registTime" width="120" align="center" headerAlign="center" dateFormat="yyyy-MM-dd HH:mm:ss"
