...
<div style="width:99%;">
    <div class="mini-toolbar" style="border-bottom:0;padding:0px;">
        <table style="width:100%;">
            <tr>
                <td style="width:100%;">
                    <form action="/drawing/exportDrawingBusiness.action" method="post" id="form2">
                        <input type="hidden" name="queryParam" id="queryParam" class="mini-hidden">
                        <a class="mini-button" iconCls="icon-add" onclick="add()">提款出金</a>
                        <a class="mini-button" iconCls="icon-download" onclick="exportDrawingBusiness()">导出</a>
                    </form>
                </td>
            </tr>
        </table>
...
<script type="text/javascript">
    ...
    function exportDrawingBusiness(){
