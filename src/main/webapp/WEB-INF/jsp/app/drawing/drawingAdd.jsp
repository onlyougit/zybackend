                ...
                <table style="table-layout:fixed;">
                    <tr>
                        ...
                        <td style="width:170px;">
                            <input name="customer.customerPhone" class="mini-textbox" required="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:100px;">客户姓名：</td>
                        <td style="width:170px;">
                            <input name="customer.customerRealName" class="mini-textbox" required="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:100px;"> 银行卡号：</td>
                        <td style="width:170px;">
                            <input name="bankCardId" class="mini-textbox" required="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:100px;">提款金额：</td>
                        <td style="width:170px;">
                            <input required="true" name='drawingAmount' format="¥#,0.00"  class='mini-spinner' minValue='0' maxValue='99999'/>
                        </td>
                    </tr>
                </table>
            </div>
...
<script type="text/javascript">
    ...
    function SaveData() {
        ...
        $('#form1').ajaxSubmit({
            url: "<c:url value='/drawing/insertDrawingSubmit.action'/>",
            success: function () {
