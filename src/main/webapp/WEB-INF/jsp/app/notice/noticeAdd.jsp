                ...
                <table style="table-layout:fixed;">
                    <tr>
                        ...
                        <td style="width:170px;">
                            <input name="title" class="mini-textbox" style="width: 350px;" emptyText="请输入公告标题" required="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:100px;">内容：</td>
                        <td style="width:170px;">
                            <textarea class="mini-textarea" name="content" id="content" required="true"
                                style="height: 120px; width: 350px;" emptyText="请输入公告内容"></textarea>
                        </td>
                    </tr>
                </table>
            </div>
...
<script type="text/javascript">
    ...
    function SaveData() {
        ...
        $('#form1').ajaxSubmit({
            url: "<c:url value='/notice/insertNoticeSubmit.action'/>",
            success: function () {
