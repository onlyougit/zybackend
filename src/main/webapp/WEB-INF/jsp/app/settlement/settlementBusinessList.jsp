    ...
    <div id="form1">
		...
		<table border="0" cellpadding="1" cellspacing="2">
			<tr>
				...
				<td>
					<input name="customer.customerName" emptyText="请输入交易账号" class="mini-textbox" onenter="search"/>
				</td>
			</tr>
		</table>
		<table>
...
<div style="width:99%;">
	<div class="mini-toolbar" style="border-bottom:0;padding:0px;">
		<table style="width:100%;">
			<tr>
				<td style="width:100%;">
					<form action="/settlement/exportSettlementBusiness.action" method="post" id="form2">
						<input type="hidden" name="queryParam" id="queryParam" class="mini-hidden">
						<a class="mini-button" iconCls="icon-download" onclick="exportSettlementBusiness()">导出</a>
					</form>
				</td>
			</tr>
		</table>
...
<div id="datagrid1" class="mini-datagrid" style="width:99%;height:75%;" sizeList="[20,30,50,100]" pageSize="20"
     url="/settlement/querySettlementBusiness.action" idField="id" allowResize="true" allowCellWrap="true"
    ...
    <div property="columns">
        <div type="indexcolumn"></div>
            ...
            <div field="customer.customerRealName" width="100" headerAlign="center" align="center">客户名称</div>
            <div field="customer.customerPhone" width="120" headerAlign="center" align="center">客户电话</div>
            <div field="customer.customerName" width="100" headerAlign="center" align="center">交易账号</div>
            <div field="sumDailyServiceCharge" width="100" headerAlign="center" align="center">当日总手续费</div>
            <div field="sumDailyServiceChargeCost" width="100" headerAlign="center" align="center">当日总手续费成本</div>
            <div field="dailyRebate" width="100" headerAlign="center" align="center">当日返佣</div>
            <div field="settlementStatusEnum.text" width="80" headerAlign="center" align="center">状态</div>
			<div field="createTime" width="130" align="center" headerAlign="center" dateFormat="yyyy-MM-dd HH:mm:ss"
...
<script type="text/javascript">
	...
	function exportSettlementBusiness(){
