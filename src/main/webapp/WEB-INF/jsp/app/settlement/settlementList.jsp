...
<div style="width:99%;">
	<div class="mini-toolbar" style="border-bottom:0;padding:0px;">
		<table style="width:100%;">
			<tr>
				<td style="width:100%;">
					<form action="/settlement/exportSettlement.action" method="post" id="form2">
						<input type="hidden" name="queryParam" id="queryParam" class="mini-hidden">
						<a class="mini-button" iconCls="icon-download" onclick="exportSettlement()">导出</a>
					</form>
				</td>
			</tr>
		</table>
...
<div id="datagrid1" class="mini-datagrid" style="width:99%;height:75%;" sizeList="[20,30,50,100]" pageSize="20"
     url="/settlement/querySettlement.action" idField="id" allowResize="true" allowCellWrap="true"
