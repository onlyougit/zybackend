...
<input type="hidden" name="id" id="bankcardId" class="mini-hidden">
             ...
             <table style="table-layout:fixed;">
                 <tr>
                     ...
                     <td style="width:170px;">
                         <div id="auditStatus" name="auditStatus" class="mini-radiobuttonlist" repeatItems="1"
									repeatLayout="table" repeatDirection="vertical"
									textField="text" valueField="code" value="1"
									url="/bankcard/getBankCardStatus.action"></div>
                     </td>
                 </tr>
             </table>
         </div>
...
<script type="text/javascript">
    ...
    function SetData(data) {
		mini.get("bankcardId").setValue(data.id);
	}
    function SaveData() {
        //表单验证
        form.validate();
        ...
        $('#form1').ajaxSubmit({
            url: "<c:url value='/bankcard/auditSubmit.action'/>",
            success: function () {
