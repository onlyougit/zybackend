    ...
    <div id="form1">
        <table border="0" cellpadding="1" cellspacing="2">
            <tr>
                <td>营业部名称：</td>
                <td>
                    <input id="" name="business.businessName" emptyText="请输入营业部名称" class="mini-textbox" onenter="search"/>
                </td>
                <td>
                    代理商名称：
                </td>
...
<div style="width:99%;">
    <div class="mini-toolbar" style="border-bottom:0;padding:0px;">
        <table style="width:100%;">
            <tr>
                <td style="width:100%;">
                    <form action="/recharge/exportRecharge.action" method="post" id="form2">
                        <input type="hidden" name="queryParam" id="queryParam" class="mini-hidden">
                    	<a class="mini-button" iconCls="icon-add" onclick="add()">增加</a>
                        <a class="mini-button" iconCls="icon-download" onclick="exportRecharge()">导出</a>
                    </form>
                </td>
            </tr>
        </table>
...
<div id="datagrid1" class="mini-datagrid" style="width:99%;height:69%;" sizeList="[20,30,50,100]" pageSize="20"
     url="/recharge/queryRecharge.action" idField="id" allowResize="true" allowCellWrap="true"
    ...
    <div property="columns">
        ...
        <div field="orderId" width="100" headerAlign="center" align="center">账单号</div>
        <div field="rechargeAmount" width="100" headerAlign="center" align="center">充值金额</div>
        <div field="rechargeWayEnum.text" width="100" headerAlign="center" align="center">充值方式</div>
		<div field="rechargeTime" width="150" align="center" headerAlign="center" dateFormat="yyyy-MM-dd HH:mm:ss"
			 allowSort="true">充值时间</div>
...
<script type="text/javascript">
    ...
    function add() {
        mini.open({
            url: "<c:url value='/recharge/addRechargePage.action'/>",
            title: "充值添加", width: 300, height: 300,
            onload: function () {
