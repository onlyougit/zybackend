                ...
                <table style="table-layout:fixed;">
                    <tr>
                        ...
                        <td style="width:170px;">
                            <input name="serviceChargeCost" class="mini-textbox" required="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:100px;">保证金标准：</td>
                        <td style="width:170px;">
                            <input name="bondStandard" class="mini-textbox" required="true"/>
                        </td>
                    </tr>
                </table>
            </div>
...
<script type="text/javascript">
    ...
    function SetData(data) {
        ...
        $.ajax({
            url: "<c:url value='/business/editQueryBusiness.action'/>",
            type: "post",
    ...
    function SaveData() {
        ...
        $('#form1').ajaxSubmit({
            url: "<c:url value='/business/updateBusinessSubmit.action'/>",//默认是form action
            success: function () {
