        ...
        <fieldset style="border:solid 1px #aaa;padding:3px;">
            ...
            <div style="padding:5px;">
                <table style="table-layout:fixed;">
                    <tr>
                        <td style="width:100px;"> 后台登录账号：</td>
                        <td style="width:170px;">
                            <input name="userName" class="mini-textbox" required="true"/>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:100px;"> 营业部名称：</td>
                        <td style="width:170px;">
                    ...
                    <tr>
                        ...
                        <td style="width:170px;">
                            <input name="shortName" class="mini-textbox" required="true"/>
                        </td>
                    </tr>
                </table>
            </div>
...
<script type="text/javascript">
    ...
    function SaveData() {
        ...
        $('#form1').ajaxSubmit({
            url: "<c:url value='/business/insertBusinessSubmit.action'/>",//默认是form action
            success: function () {
