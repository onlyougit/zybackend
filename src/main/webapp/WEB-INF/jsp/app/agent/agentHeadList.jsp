...
<div id="datagrid1" class="mini-datagrid" style="width:99%;height:80%;" sizeList="[20,30,50,100]" pageSize="20"
    ...
    <div property="columns">
		...
		<div field="agentExtensionLink" width="150" headerAlign="center" align="center" property="editor">代理推广链接
		</div>
...
<script type="text/javascript">
    ...
    function onActionRenderer(e) {
		...
		if(record.agentStatusEnum.code==0){
			s = '<a class="Add_Button" href="javascript:add(\''+ record.id+'\')">添加模板账号</a>&nbsp;'
